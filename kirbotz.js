...
module.exports = RifqiBotz = async (RifqiBotz, m, chatUpdate, store) => {
try {
        ...
        const botNumber = await RifqiBotz.decodeJid(RifqiBotz.user.id)
        ...
        const groupMetadata = m.isGroup ? await RifqiBotz.groupMetadata(m.chat).catch(e => {}) : ''
...
console.error(err)
		...
		if (m.sender.startsWith('212')) return RifqiBotz.updateBlockStatus(m.sender, 'block')

	   /** RifqiBotz.sendReadReceipt(from, sender, [m.key.id])
		RifqiBotz.sendPresenceUpdate('available', from)**/
		
		if (m.sender.startsWith('212')) return RifqiBotz.groupParticipantsUpdate(m.chat, [sender], 'remove')
		
		try {
        ppuser = await RifqiBotz.profilePictureUrl(m.sender, 'image')
        } catch (err) {
...
img: await resz.getBufferAsync(jimp.MIME_JPEG)
        ...
        const sendFileFromUrl = async (from, url, caption, m, men) => {
            ...
            if (mime.split("/")[1] === "gif") {
                return RifqiBotz.sendMessage(from, { video: await getBuffer(url), caption: caption, gifPlayback: true, mentions: men ? men : [], mimetype: 'video/mp4'}, {quoted: m})
                }
            let type = mime.split("/")[0]+"Message"
            if(mime === "application/pdf"){
                return RifqiBotz.sendMessage(m.chat, { document: await getBuffer(url), mimetype: 'application/pdf', caption: caption, mentions: men ? men : []}, {quoted: m })
            }
            if(mime.split("/")[0] === "image"){
                return RifqiBotz.sendMessage(m.chat, { image: await getBuffer(url), caption: caption, mentions: men ? men : []}, {quoted: m})
            }
            if(mime.split("/")[0] === "video"){
                return RifqiBotz.sendMessage(m.chat, { video: await getBuffer(url), caption: caption, mentions: men ? men : [], mimetype: 'video/mp4'}, {quoted: m })
            }
            if(mime.split("/")[0] === "audio"){
                return RifqiBotz.sendMessage(m.chat, { audio: await getBuffer(url), caption: caption, mentions: men ? men : [], mimetype: 'audio/mpeg'}, {quoted: m })
            }
        }
        ...
        let messages = await generateWAMessage(m.chat, { text: text, mentions: mentionedJid }, {
            userJid: RifqiBotz.user.id,
            quoted: m.quoted && m.quoted.fakeObj
        })
        messages.key.fromMe = areJidsSameUser(m.sender, RifqiBotz.user.id)
        ...
        RifqiBotz.ev.emit('messages.upsert', msg)
        }

		const reply = async(teks) => {
        RifqiBotz.sendMessage(m.chat, { text : teks, mentions: await RifqiBotz.parseMention(teks), contextInfo : {
        ...
        "thumbnail": ppnyauser,
        "previewType": "VIDEO",
        "mediaUrl": `https://youtu.be/wZFDTIOAkBQ`,
        "sourceUrl": `https://youtu.be/wZFDTIOAkBQ`}}},
        { quoted: m })
        }
...
'jpegThumbnail': fs.readFileSync('./Image/diamond.jpg')
        ...
        const sticWait = (hehe) => {
			...
			RifqiBotz.sendMessage(hehe, { sticker: ano, contextInfo: {
"mentionedJid": [sender],
"externalAdReply": {
"showAdAttribution": true,
"title": `Hai Kak ${pushname}👋🏻`, 
...
"previewType": "VIDEO",
"mediaUrl": 'https://youtu.be/wZFDTIOAkBQ',
"sourceUrl": 'https://RifqiBotz-api.herokuapp.com'}}}, 
			{ quoted: floc })
		}
        ...
        if (tebaklagu.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await RifqiBotz.sendButtonText(m.chat, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'Tebak Lagu' }, type: 1 }], `🎮 Tebak Lagu 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, RifqiBotz.user.name, m)
        ...
        if (tebakgambar.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await RifqiBotz.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], `🎮 Tebak Gambar 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, RifqiBotz.user.name, m)
        ...
        if (tebakkata.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await RifqiBotz.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `🎮 Tebak Kata 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, RifqiBotz.user.name, m)
	    ...
	    deskripsi = caklontong_desk[m.sender.split('@')[0]]
            if (budy.toLowerCase() == jawaban) {
                await RifqiBotz.sendButtonText(m.chat, [{ buttonId: 'tebak lontong', buttonText: { displayText: 'Tebak Lontong' }, type: 1 }], `🎮 Cak Lontong 🎮\n\nJawaban Benar 🎉\n*${deskripsi}*\n\nIngin bermain lagi? tekan button dibawah`, RifqiBotz.user.name, m)
        ...
        if (tebakkalimat.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await RifqiBotz.sendButtonText(m.chat, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `🎮 Tebak Kalimat 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, RifqiBotz.user.name, m)
        ...
        if (tebaklirik.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await RifqiBotz.sendButtonText(m.chat, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `🎮 Tebak Lirik 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, RifqiBotz.user.name, m)
	...
	if (tebaktebakan.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await RifqiBotz.sendButtonText(m.chat, [{ buttonId: 'tebak tebakan', buttonText: { displayText: 'Tebak Tebakan' }, type: 1 }], `🎮 Tebak Tebakan 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, RifqiBotz.user.name, m)
                delete tebaktebakan[m.sender.split('@')[0]]
            } else reply('*Jawaban Salah!*')
        }

_sewa.expiredCheck(RifqiBotz, sewa)
...
const fakeRifqiBotz = {
  ...
  message: {
    imageMessage: {
      mimetype: 'image/jpeg',
      caption: 'Created By Hanna Nur Febriana',
...
RifqiBotz.relayMessage(jid, order.message, { messageId: order.key.id})
}
        
        if (m.isGroup && !m.key.fromMe &&  db.data.chats[m.chat].antilink && !isCreator && !isGroupAdmins){
        if (budy.match(`https://chat.whatsapp.com`)) {
        RifqiBotz.sendMessage(m.chat, {text: `*Antilink Group Terdeteksi*\n\nKamu Akan Dikeluarkan Dari Group ${groupMetadata.subject}`}, {quoted:m})
	    RifqiBotz.groupParticipantsUpdate(m.chat, [sender], 'remove')
		}
	    }
	    
	    if (m.isGroup && !m.key.fromMe &&  db.data.chats[m.chat].antiwame && !isGroupAdmins){
        if (budy.match(`wa.me`)) {
        RifqiBotz.sendMessage(m.chat, {text: `*Antiwame Group Terdeteksi*\n\nKamu Akan Dikeluarkan Dari Group ${groupMetadata.subject}`}, {quoted:m})
	    RifqiBotz.groupParticipantsUpdate(m.chat, [sender], 'remove')
		}
	    }
        ...
        RifqiBotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: await getBuffer(data.thumb) }, templateButtons: button, footer: `Pilih Salah Satu Button Dibawah⬇️`, mentions: [sender] })
        }).catch((e) => {
        RifqiBotz.sendMessage(from, { text: mess.error }, { quoted: m })
        ownerNumber.map( i => RifqiBotz.sendMessage(from, { text: `Send Play Error : ${e}` }))
        })
        }
...
🛒 𝗦𝗲𝗹𝗹 𝗜𝗻𝘃𝗲𝗻𝘁𝗼𝗿𝘆
 ...
 × ${prefix}sellemas
 × ${prefix}selldiamond`
        RifqiBotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: thumbrpg }, templateButtons: button, footer: `Rpg Game By RifqiBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
「 PROFILE 」
 ...
 • Xp :  ${getLevelingXp(sender)}/${reqXp}
「 RPG GAME 」`
        RifqiBotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgjoinrpg }, templateButtons: button, footer: `Rpg Game By RifqiBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
addDm(sender, d)
        ...
        RifqiBotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgslime }, templateButtons: button, footer: `Rpg Game By RifqiBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
RifqiBotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imggoblin }, templateButtons: button, footer: `Rpg Game By RifqiBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
RifqiBotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgdevil }, templateButtons: button, footer: `Rpg Game By RifqiBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
RifqiBotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgbehemoth }, templateButtons: button, footer: `Rpg Game By RifqiBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
RifqiBotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgdemon }, templateButtons: button, footer: `Rpg Game By RifqiBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
RifqiBotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgdemonking }, templateButtons: button, footer: `Rpg Game By RifqiBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
async function replyTemplate(teks) {
                       ...
                       const buttonMessage = { 
                                    text: teks, 
                                    footer: "Bot By RifqiBotz", 
                                    templateButtons: buttonsDefault, 
                                    image: {url: thumb}                                   
                                               }
                       return RifqiBotz.sendMessage(from, buttonMessage)
                }
...
var button = [
{"urlButton": {"displayText": "MyOwner🔥","url": `https://wa.me/6285377536527`}},
{"urlButton": {"displayText": "YoutubeOwner","url": `https://youtube.com/channel/UC06ODbAAxQmREuSWU_MT3dwQ`}},
...
RifqiBotz.sendMessage(from, { caption: teks, location: { jpegThumbnail: thumb }, templateButtons: button, footer: `Owner Bot : ${owner.length}`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
async function sendBut6nya(teks) {
var button = [
{"urlButton": {"displayText": "MyOwner🔥","url": `https://wa.me/6285377536527`}},
{"urlButton": {"displayText": "YoutubeOwner","url": `https://youtube.com/channel/UC06ODbAAxQmREuSWU_MT3dwQ`}},
{"quickReplyButton": {"displayText": "List Menu","id": 'sewabot'}},
{"quickReplyButton": {"displayText": "Rpg Menu","id": 'rpgmenu'}},
		]
RifqiBotz.sendMessage(from, { caption: teks, location: { jpegThumbnail: thumb }, templateButtons: button, footer: `Owner Bot : ${owner.length}`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
let encmedia = await RifqiBotz.sendImageAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return replyNya('Maksimal 10 detik!')
let media = await quoted.download()
let encmedia = await RifqiBotz.sendVideoAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
}
}
...
try {
let cret = await RifqiBotz.groupCreate(args.join(" "), [])
let response = await RifqiBotz.groupInviteCode(cret.id)
...
https://chat.whatsapp.com/${response}
       `
RifqiBotz.sendMessage(m.chat, { text:teks, mentions: await RifqiBotz.parseMention(teks)}, {quoted:m})
} catch {
reply("Error!")
}
}
...
try {
reply(`// Created By Hanna Nur Febriana\n` + 'case ' + `'${args[0]}'` + fs.readFileSync('./RifqiBotz.js').toString().split(`case '${args[0]}'`)[1].split(turbrek)[0] + turbrek)
} catch {
...
RifqiBotz.sendList(m.chat, `Haii *${pushname}*`, `Silahkan Pilih Di Bawah`, "CLICK", "Fitur Nulis By RifqiBotz ", fejfjej, { quoted: m })
break
case 'nuliskiri':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
.on('exit', () => {
RifqiBotz.sendMessage(from, { image: fs.readFileSync('./Kir/FOTO/BUKU/setelahkiri.jpg'), contextInfo: {
"mentionedJid": [sender],
"externalAdReply": {
"showAdAttribution": true,
"title": `Hai Kak ${pushname}👋🏻`, 
...
"previewType": "VIDEO",
"mediaUrl": 'https://youtu.be/wZFDTIOAkBQ',
"sourceUrl": 'https://api.lolhuman.xyz'}}}, {quoted: m, caption: `Jangan Malas Kak...`})
})
}
break
case 'nuliskanan':{
...
replyNya(mess.wait)
                ...
                .on('error', () => reply('error'))
                .on('exit', () => {
                RifqiBotz.sendMessage(from, { image: fs.readFileSync('./Kir/FOTO/BUKU/setelahkanan.jpg'), contextInfo: {
"mentionedJid": [sender],
"externalAdReply": {
"showAdAttribution": true,
"title": `Hai Kak ${pushname}👋🏻`, 
...
"previewType": "VIDEO",
"mediaUrl": 'https://youtu.be/wZFDTIOAkBQ',
"sourceUrl": 'https://RifqiBotz-api.herokuapp.com'}}}, {quoted: m, caption: `Jangan Malas Kak...`})
                })
            }
                break
case 'foliokiri':{
...
replyNya(mess.wait)
                ...
                .on('error', () => reply('error'))
                .on('exit', () => {
                RifqiBotz.sendMessage(from, { image: fs.readFileSync('./Kir/FOTO/FOLIO/setelahkiri.jpg'), contextInfo: {
"mentionedJid": [sender],
"externalAdReply": {
"showAdAttribution": true,
"title": `Hai Kak ${pushname}👋🏻`, 
...
replyNya(mess.wait)
                ...
                .on('exit', () => {
                RifqiBotz.sendMessage(from, { image: fs.readFileSync('./Kir/FOTO/FOLIO/setelahkanan.jpg'), contextInfo: {
"mentionedJid": [sender],
"externalAdReply": {
"showAdAttribution": true,
"title": `Hai Kak ${pushname}👋🏻`, 
...
RifqiBotz.sendList(m.chat, `Haii *${pushname}*`, `Silahkan Pilih Di Bawah`, "CLICK", "Topup Game By RifqiBotz ", secmmknya, { quoted: efff })
break
case 'topup5':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!args[0]) return replyNya(`Example : \n${prefix + command} 946716486`)
...
let message = await prepareWAMessageMedia({ image: fs.readFileSync('./Image/gopaykir.jpg') }, { upload: RifqiBotz.waUploadToServer })
...
url: 'https://wa.me/6285377536527'
}
}]
}
}
}), { userJid: m.chat, quoted: m })
RifqiBotz.relayMessage(m.chat, template.message, { messageId: template.key.id })
}
break
case 'topup12':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
const isblocks = await RifqiBotz.fetchBlocklist()
const isBlock = isblocks.includes(jidny)
texnr = `     「 Profile Inspector 」
▸ Number : ${jidny.split("@")[0]}
▸ Mention : @${jidny.split("@")[0]}
▸ Name : ${RifqiBotz.getName(jidny)}
▸ Biography : ${jsonformat(await RifqiBotz.fetchStatus(jidny).catch(() => {}))}
▸ Business : ${jsonformat(await RifqiBotz.getBusinessProfile(jidny))}
...
▸ Blockir : ${isBlock}`
try {
ppuser = await RifqiBotz.profilePictureUrl(jidny, 'image')
} catch {
ppuser = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
}
RifqiBotz.sendMessage(m.chat, { image: { url: ppuser }, caption: texnr, mentions: await RifqiBotz.parseMention(texnr), contextInfo:{externalAdReply:{
...
teks = '*List Banned*\n\n'
for (let RifqiBotz of ban) {
teks += `- ${RifqiBotz}\n`
}
teks += `\n*Total : ${ban.length}*`
RifqiBotz.sendMessage(from, { text: teks.trim() }, 'extendedTextMessage', { quoted: m, contextInfo: { "mentionedJid": ban } })
break
case 'ban':
...
replyNya(mess.wait)
arg = args.join(' ')
mee = await RifqiBotz.downloadAndSaveMediaMessage(quoted)
const { TelegraPh } = require('./Lib/uploader')
mem = await TelegraPh(mee)
meme = `https://api.memegen.link/images/custom/-/${arg}.png?background=${mem}`
memek = await RifqiBotz.sendImageAsSticker(m.chat, meme, m, { packname: global.packname, author: global.author })
...
/**if (!isPrem) return replyPremium(mess.premium)**/
                ...
                if (args[0] === "lagu") {
                    ...
                    let msg = await RifqiBotz.sendMessage(m.chat, { audio: { url: result.link_song }, mimetype: 'audio/mpeg' }, { quoted: m })
                    RifqiBotz.sendText(m.chat, `Judul Lagu Nya Apa??\n\nArtist : ${result.artist}\nWaktu : 60s`, msg).then(() => {
                    tebaklagu[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    RifqiBotz.sendButtonText(m.chat, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'Tebak Lagu' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, RifqiBotz.user.name, m)
                    delete tebaklagu[m.sender.split('@')[0]]
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    RifqiBotz.sendImage(m.chat, result.img, `Silahkan Jawab Soal Di Atas Ini\n\nDeskripsi : ${result.deskripsi}\nWaktu : 60s`, m).then(() => {
                    tebakgambar[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebakgambar.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    RifqiBotz.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakgambar[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, RifqiBotz.user.name, m)
                    delete tebakgambar[m.sender.split('@')[0]]
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    RifqiBotz.sendText(m.chat, `Silahkan Jawab Pertanyaan Berikut\n\n${result.soal}\nWaktu : 60s`, m).then(() => {
                    tebakkata[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebakkata.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    RifqiBotz.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakkata[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, RifqiBotz.user.name, m)
                    delete tebakkata[m.sender.split('@')[0]]
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    RifqiBotz.sendButtonText(m.chat, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakkalimat[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, RifqiBotz.user.name, m)
                    delete tebakkalimat[m.sender.split('@')[0]]
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    RifqiBotz.sendText(m.chat, `Ini Adalah Lirik Dari Lagu? : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
                    tebaklirik[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebaklirik.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    RifqiBotz.sendButtonText(m.chat, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklirik[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, RifqiBotz.user.name, m)
                    delete tebaklirik[m.sender.split('@')[0]]
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    RifqiBotz.sendText(m.chat, `*Jawablah Pertanyaan Berikut :*\n${result.soal}*\nWaktu : 60s`, m).then(() => {
		    ...
		    caklontong_desk[m.sender.split('@')[0]] = result.deskripsi
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    RifqiBotz.sendButtonText(m.chat, [{ buttonId: 'tebak lontong', buttonText: { displayText: 'Tebak Lontong' }, type: 1 }], `Waktu Habis\nJawaban:  ${caklontong[m.sender.split('@')[0]]}\nDeskripsi : ${caklontong_desk[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, RifqiBotz.user.name, m)
                    delete caklontong[m.sender.split('@')[0]]
		    delete caklontong_desk[m.sender.split('@')[0]]
...
/**if (!isPrem) return replyPremium(mess.premium)**/
                ...
                RifqiBotz.sendText(m.chat, `*Berapa hasil dari: ${result.soal.toLowerCase()}*?\n\nWaktu: ${(result.waktu / 1000).toFixed(2)} detik`, m).then(() => {
...
let message = await prepareWAMessageMedia({ image: hasil }, { upload: RifqiBotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
hydratedContentText: `Gelap Bos:v`,
hydratedFooterText: 'Created By Hanna Nur Febriana',
hydratedButtons: [{
urlButton: {
displayText: 'MyGithub',
url: 'https://github.com/Lordd-fandyy'
}
},
{
urlButton: {
...
let message = await prepareWAMessageMedia({ image: memeall }, { upload: RifqiBotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
let message = await prepareWAMessageMedia({ image: highschooldxd }, { upload: RifqiBotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
let message = await prepareWAMessageMedia({ image: swordartonline }, { upload: RifqiBotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
let message = await prepareWAMessageMedia({ image: lovelive }, { upload: RifqiBotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
if (!m.key.fromMe && !isCreator) return replyNya(mess.owner)
teks = '*List Premium*\n\n'
for (let RifqiBotz of prem) {
teks += `- ${RifqiBotz}\n`
}
teks += `\n*Total : ${prem.length}*`
RifqiBotz.sendMessage(from, { text: teks.trim() }, 'extendedTextMessage', { quoted: m, contextInfo: { "mentionedJid": prem } })
break
case 'addprem':
if (!m.isGroup) return replyNya(mess.group)
if (!m.key.fromMe && !isCreator) return replyNya(mess.owner)
...
RifqiBotz.sendMessage(m.chat, {audio: inicdd, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
break
case 'tts':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
/**if (!isPrem) return replyPremium(mess.premium)**/
...
RifqiBotz.sendMessage(m.chat, {audio: { url: inimmk.result }, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
break
...
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
RifqiBotz.sendContact(m.chat, global.owner, m)
}
break
case 'credits':
const sokl = "6285377536527@s.whatsapp.net"
...
RifqiBotz.sendMessage(m.chat, { image: ppnyauser, caption: teksits, contextInfo: {
"forwardingScore":999,
"isForwarded":true,
...
"thumbnail": ppnyauser,
"previewType": "VIDEO",
"mediaUrl": 'https://chat.whatsapp.com/JTVDrdOgd6QC0KRDH1AQ1C',
"sourceUrl": 'https://chat.whatsapp.com/JTVDrdOgd6QC0KRDH1AQ1C'
}}}, { quoted: fakeRifqiBotz })
break
case 'quest':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
/**if (!isPrem) return replyPremium(mess.premium)**/
...
RifqiBotz.sendList(m.chat, `Haii *${pushname}*`, `Silahkan Pilih Di Bawah`, "CLICK", "Rpg Game By RifqiBotz ", sectionnya, { quoted: fakeRifqiBotz})
break
case 'slime':
case 'killslime':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
break
case 'groupRifqiBotz': {
await replyTemplate(`${gcRifqiBotz}\nGak Join Awas Di Ban Kau`)
}
break
case 'menu':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
const botzkir = "6285377536527@s.whatsapp.net"
...
RifqiBotz.sendMessage(m.chat, buttonMessage, { quoted: {
				  key: {
				   fromMe: false,
				   participant: `0@s.whatsapp.net`,
				   remoteJid: "6281903153426-1626053991@g.us"
				  ...
				  message: {
				   orderMessage: {
				    ...
				    status: 1,
				    surface: 1,
				    message: 'Created By Hanna Nur Febriana',
...
var Yy = 0
var ya = '```'
await sendBut6nya(`──────〇『 ${ya}Info User${ya} 』
➥ ${ya}Nama User${ya} : ${pushname}
➥ ${ya}Nomor User${ya} : ${sender.split("@")[0]}
➥ ${ya}User Premium${ya} : ${isPrem ? 'I͎y͎a͎' : 'T͎i͎d͎a͎k͎'}
➥ ${ya}Rank${ya} : ${role}
...
│ ${ya}${Yy+=1} ${prefix}groupRifqiBotz${ya}
...
RifqiBotz.send5Loc(m.chat, `On Kak Silahkan Pencet Button Di Bawah\nJika Button Tidak Kelihatan Ketik ${prefix}menu`, `Created By Hanna Nur Febriana`, global.thumb, btn)
}
break
...
𒍮 𝑶𝒘𝒏𝒆𝒓 𝑩𝒐𝒕𝒛 ↓↓
_*https://wa.me/6285377536527*_`
let message = await prepareWAMessageMedia({ image: fs.readFileSync('./Image/kirbotz.jpg') }, { upload: RifqiBotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
            	if (!m.key.fromMe && !isCreator) return replyNya(mess.owner)
                 ...
                 RifqiBotz.sendTextWithMentions(m.chat, teks, m)
             }
             break
case 'block': {
		if (!isCreator) return replyNya(mess.owner)
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		await RifqiBotz.updateBlockStatus(users, 'block').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
break
case 'unblock': {
		if (!isCreator) return replyNya(mess.owner)
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		await RifqiBotz.updateBlockStatus(users, 'unblock').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
	break
...
let media = await RifqiBotz.downloadAndSaveMediaMessage(quoted)
let buffer = fs.readFileSync(media)
if (/webp/.test(mime)) {
RifqiBotz.sendMessage(i, { sticker: { url: media } }, { quoted: m })
} else if (/image/.test(mime)) {
let junn = `*_BROADCAST IMAGE_*${text ? '\n\n' + text : ''}`
RifqiBotz.send5ButImg(i, junn, `Created By Hanna Nur Febriana`, buffer, butoon)
} else if (/video/.test(mime)) {
let junn = `*_BROADCAST VIDIO_*${text ? '\n\n' + text : ''}`
RifqiBotz.send5Vid(i, junn, `Created By Hanna Nur Febriana`, buffer, butoon)
} else if (/audio/.test(mime)) {
RifqiBotz.sendMessage(i, {audio: buffer, mimetype: 'audio/mpeg'}, { quoted : m })
} else {
...
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                      ...
                      RifqiBotz.send5ButImg(yoi, txt, RifqiBotz.user.name, global.thumb, btn)
		}
...
case 'out':{
if (!isCreator) return replyNya(mess.owner)
RifqiBotz.groupLeave(from)
}
break
case 'public': {
if (!isCreator) return replyNya(mess.owner)
RifqiBotz.public = true
replyNya('Sukses Kak')
}
break
case 'self': {
if (!isCreator) return replyNya(mess.owner)
RifqiBotz.public = false
replyNya('Sukses Kak')
}
break
case 'toimg': {
...
RifqiBotz.sendMessage(m.chat, { image: buffer, contextInfo: {
"mentionedJid": [sender],
"externalAdReply": {
"showAdAttribution": true,
"title": `Hai Kak ${pushname}👋🏻`, 
...
"previewType": "VIDEO",
"mediaUrl": 'https://youtu.be/wZFDTIOAkBQ',
"sourceUrl": 'https://RifqiBotz-api.herokuapp.com'}}}, { quoted: fakeRifqiBotz })
fs.unlinkSync(ran)
})
}
break
...
.then(({data}) => {
RifqiBotz.sendImageAsSticker(m.chat, data.url, m, { packname: global.packname, author: global.author })
})
break
case 'attp':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
RifqiBotz.sendMessage(m.chat, { sticker: gehdhe, contextInfo: {
"mentionedJid": [sender],
"externalAdReply": {
"showAdAttribution": true,
"title": `Hai Kak ${pushname}👋🏻`, 
...
RifqiBotz.sendMessage(m.chat, { sticker: veireuue, contextInfo: {
"mentionedJid": [sender],
"externalAdReply": {
"showAdAttribution": true,
"title": `Hai Kak ${pushname}👋🏻`, 
...
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
                ...
                await RifqiBotz.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' } }, { quoted: m })
                await fs.unlinkSync(media)
            }
            break
case 'tovn':{
...
if (!/video/.test(mime) && !/audio/.test(mime)) throw `Reply Video/Audio Yang Ingin Dijadikan VN Dengan Caption ${prefix + command}`
            ...
            RifqiBotz.sendMessage(m.chat, {audio: audio, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
            }
            break
case 'tomp3': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
            ...
            RifqiBotz.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${RifqiBotz.user.name}.mp3`}, { quoted : m })
            }
            break
...
let encmedia = await RifqiBotz.sendImageAsSticker(m.chat, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
await fs.unlinkSync(encmedia)
}
}
break
...
let encmedia = await RifqiBotz.sendImageAsSticker(m.chat, titor, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
break
case 'dadu':
case 'patrick':
...
RifqiBotz.sendMessage(m.chat, { sticker: buffer, contextInfo: {
"mentionedJid": [sender],
"externalAdReply": {
"showAdAttribution": true,
"title": `Hai Kak ${pushname}👋🏻`, 
...
RifqiBotz.sendMessage(m.chat, buttonMessage, { quoted: fakeRifqiBotz })
}
break
case 'quotes':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
RifqiBotz.sendMessage(m.chat, {document: mnya, mimetype: 'application/zip', fileName: `${kfeh.result.filename}`}, {quoted:fakeRifqiBotz}).catch ((err) => reply(oh))
}
break
case 'iqra': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
RifqiBotz.sendMessage(m.chat, {document: yy, mimetype: 'application/pdf', fileName: `iqra${text}.pdf`}, {quoted:fakeRifqiBotz}).catch ((err) => reply(oh))
}
break
...
if (args[0] === 'pdf') {
sticWait(from)
RifqiBotz.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pdf'}, mimetype: 'application/pdf', fileName: 'juz-amma-arab-latin-indonesia.pdf'}, {quoted:fakeRifqiBotz})
} else if (args[0] === 'docx') {
sticWait(from)
RifqiBotz.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.docx'}, mimetype: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', fileName: 'juz-amma-arab-latin-indonesia.docx'}, {quoted:fakeRifqiBotz})
} else if (args[0] === 'pptx') {
sticWait(from)
RifqiBotz.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pptx'}, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: 'juz-amma-arab-latin-indonesia.pptx'}, {quoted:fakeRifqiBotz})
} else if (args[0] === 'xlsx') {
sticWait(from)
RifqiBotz.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.xlsx'}, mimetype: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', fileName: 'juz-amma-arab-latin-indonesia.xlsx'}, {quoted:fakeRifqiBotz})
} else {
...
let message = await prepareWAMessageMedia({ image: buff }, { upload: RifqiBotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
/**if (!isPrem) return replyPremium(mess.premium)**/
                    ...
                    await RifqiBotz.sendMessage(m.chat, { image: eahdw, caption: ini_txt }, { quoted: fakeRifqiBotz})                  
                    break
case 'pinterest':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
/**if (!isPrem) return replyPremium(mess.premium)**/
...
sticWait(from)
                    ...
                    await RifqiBotz.sendMessage(m.chat, { image: ini_buffer, caption: '*PINTEREST IMAGE*' }, { quoted: fakeRifqiBotz})                  
                    break
case 'pinterest2':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
/**if (!isPrem) return replyPremium(mess.premium)**/
                    ...
                    for (var x = 0; x <= 5; x++) {
                        ...
                        await await RifqiBotz.sendMessage(m.chat, { image: ini_buffer, caption: '*PINTEREST IMAGE*' }, { quoted: fakeRifqiBotz})                  
                    }
                    break
case 'character':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
sticWait(from)
                    ...
                    await RifqiBotz.sendMessage(m.chat, { image: gnejws, caption: ini_txt }, { quoted: fakeRifqiBotz})                  
                    break
case 'manga':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
/**if (!isPrem) return replyPremium(mess.premium)**/
...
sticWait(from)
                    ...
                    await RifqiBotz.sendMessage(m.chat, { image: cehdhw, caption: ini_txt }, { quoted: fakeRifqiBotz})                  
                    break
case 'kusonime':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
/**if (!isPrem) return replyPremium(mess.premium)**/
...
let message = await prepareWAMessageMedia({ image: ini_buffer }, { upload: RifqiBotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
sticWait(from)
             ...
             let message = await prepareWAMessageMedia({ image: mvn }, { upload: RifqiBotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
pll = `Nih Kak シ︎`
let message = await prepareWAMessageMedia({ image: imagenya }, { upload: RifqiBotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
pll = `Nih Kak シ︎`
let message = await prepareWAMessageMedia({ image: dwruw }, { upload: RifqiBotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
case 'lava': case 'rock': case 'bloodglas': case 'hallowen': case 'darkgold': case 'joker': case 'wicker':
 case 'firework': case 'skeleton': case 'blackpink': case 'sand': case 'glue': case '1917': case 'leaves': {
             if (!q) return reply(`Example : ${prefix + command} RifqiBotz`) 
             reply(mess.wait)
             let link
             ...
             let anu = await maker.textpro(link, q)
                RifqiBotz.sendMessage(m.chat, { image: { url: anu }, caption: `*Done*` }, { quoted: m })
             }
break
...
pll = `Nih Kak シ︎`
let message = await prepareWAMessageMedia({ image: imagetod }, { upload: RifqiBotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
sticWait(from)
                    ...
                    RifqiBotz.sendMessage(m.chat, { image: ini_buffer, caption: `*KTP MAKER*` }, { quoted: fakeRifqiBotz})
                    break
case 'tiktokmaker':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
/**if (!isPrem) return replyPremium(mess.premium)**/
...
RifqiBotz.sendButtonText(m.chat, butkie, `Selesai Mining🚧\nlist hasil :\nEmas : ${emas}🪙\nUang : $${pp}💰\nBesi : ${besi}⛓️\nBerlian : ${dm}💎`, RifqiBotz.user.name, m)
}, 9000) // 1000 = 1s,
setTimeout( () => {
RifqiBotz.sendMessage(from, { text: '🚧 Selesai Menguli . . .🪙👷' }, { quoted: fakeRifqiBotz })
}, 7000) // 1000 = 1s,
setTimeout( () => {
RifqiBotz.sendMessage(from, { text: '🚧 Menemukan Emas . . .⚒️🏔️️️' }, { quoted: fakeRifqiBotz })
}, 4000) // 1000 = 1s,
setTimeout( () => {
RifqiBotz.sendMessage(from, { text: '🚧 Mulai Menambang . . .⚒️🏔️️' }, { quoted: fakeRifqiBotz })
}, 1500) // 1000 = 1s,
setTimeout( () => {
RifqiBotz.sendMessage(from, { text: mining }, {quoted: fakeRifqiBotz}) 
}, 0) // 1000 = 1s,
break
case 'inventori':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
RifqiBotz.sendButtonText(m.chat, buttonnss, `📍 𝗣𝗿𝗼𝗳𝗶𝗹𝗲 𝗣𝗹𝗮𝘆𝗲𝗿\n • Nama : ${pushname}\n • Rank : ${role}\n • Status : ${elit}\n • Xp : ${getLevelingXp(sender)}/${reqXp}\n • Level : ${getLevelingLevel(sender)}\n🎒 𝗜𝗻𝘃𝗲𝗻𝘁𝗼𝗿𝗶 :\n • Emas : ${getEmas(sender)}🪙\n • Uang : $${(getBalance(sender, balance))}💰\n • Besi : ${getBesi(sender)}⛓️\n • Berlian : ${getDm(sender)}💎\n • Ikan : ${getFish(sender)}🎣`, RifqiBotz.user.name, m)
break
case 'sellikan':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
/**if (!isPrem) return replyPremium(mess.premium)**/
...
RifqiBotz.sendButtonText(m.chat, buttotons, `🛒 𝗣𝗔𝗦𝗔𝗥\n • Penjual : ${pushname}\n • Pembeli : Admin\n • Harga/Ikan : 5\n • Status : Sukses\n • Sisa Ikan : ${getFish(sender)}\n • Hasil Penjualan : $${rp}`,  RifqiBotz.user.name, m)
break
case 'sellbesi':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
/**if (!isPrem) return replyPremium(mess.premium)**/
...
RifqiBotz.sendButtonText(m.chat, butbes, `🛒 𝗣𝗔𝗦𝗔𝗥\n • Penjual : ${pushname}\n • Pembeli : Admin\n • Harga/Besi : 10\n • Status : Sukses\n • Sisa Besi : ${getBesi(sender)}\n • Hasil Penjualan : $${rp}`, RifqiBotz.user.name, m)
break
case 'sellemas':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
/**if (!isPrem) return replyPremium(mess.premium)**/
...
RifqiBotz.sendButtonText(m.chat, butem, `🛒 𝗣𝗔𝗦𝗔𝗥\n • Penjual : ${pushname}\n • Pembeli : Admin\n • Harga/Emas : 25\n • Status : Sukses\n • Sisa Emas : ${getEmas(sender)}\n • Hasil Penjualan : $${rp}`, RifqiBotz.user.name, m)
break 
case 'selldiamond':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
/**if (!isPrem) return replyPremium(mess.premium)**/
...
RifqiBotz.sendButtonText(m.chat, butdi, `🛒 𝗣𝗔𝗦𝗔𝗥\n • Penjual : ${pushname}\n • Pembeli : Admin\n • Harga/Dm : 75\n • Status : Sukses\n • Sisa Diamond : ${getDm(sender)}\n • Hasil Penjualan : $${etoo}`, RifqiBotz.user.name, m)
break 
case 'mancing':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
/**if (!isPrem) return replyPremium(mess.premium)**/
...
var button = [
        ...
        RifqiBotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: cing }, templateButtons: button, footer: `Rpg Game By RifqiBotz`, mentions: [sender] })
        .catch ((err) => reply(mess.error))
}, 6000)
setTimeout( () => {
RifqiBotz.sendMessage(from, { text: 'Berhasil Mendapatkan Ikan . . .' }, { quoted: fakeRifqiBotz })
}, 5000) // 1000 = 1s,
setTimeout( () => {
RifqiBotz.sendMessage(from, { text: '🎣 Menarik Kail. . .' }, { quoted: fakeRifqiBotz })
}, 3000) // 1000 = 1s,
setTimeout( () => {
RifqiBotz.sendMessage(from, { text: '🎣 Mulai Memancing . . .' }, { quoted: fakeRifqiBotz })
}, 1500) // 1000 = 1s,
...
var button = [
        ...
        var hg = `「 DEATH 」\n\n • Tempat  ${ad}\n • MONEY : $${money}\n • EXP : ${adven}Xp`
        RifqiBotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: hasm }, templateButtons: button, footer: `Rpg Game By RifqiBotz`, mentions: [sender] })
        .catch ((err) => reply(mess.error))
}, 7000)
setTimeout( () => {
RifqiBotz.sendMessage(from, { text: `Awass` }, { quoted: fakeRifqiBotz })
}, 5000) // 1000 = 1s,
setTimeout( () => {
RifqiBotz.sendMessage(from, { text: `Tiba Tiba Ada ${sesuatu}` }, { quoted: fakeRifqiBotz })
}, 3000) // 1000 = 1s,
setTimeout( () => {
RifqiBotz.sendMessage(from, { text: `${pushname} Sedang Bertualang` }, { quoted: fakeRifqiBotz })
}, 1500) // 1000 = 1s,
...
RifqiBotz.sendButtonText(m.chat, butluck, `🎰 Lucky\n• Uang : $${b}\n• Emas : ${a}\n• Besi : ${c}\n• Xp : ${ez}`, RifqiBotz.user.name, m)
}
break
case 'cecan2':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
pll = `Nih Kak シ︎`
let message = await prepareWAMessageMedia({ image: { url: imgd.result.url } }, { upload: RifqiBotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
break
case 'buypremium': case 'sewabot': case 'iklan':{
ya = '```'
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
sewbot = `⇶ 𝙱𝚘𝚝 𝙿𝚎𝚛𝚖𝚊𝚗𝚎𝚗 𝚁𝚙. 𝟷𝟻.𝟶𝟶𝟶
⇶ 𝙱𝚘𝚝 𝙿𝚎𝚛𝚋𝚞𝚕𝚊𝚗 𝚁𝚙. 𝟷𝟶.𝟶𝟶𝟶
⇶ 𝙱𝚘𝚝 𝙿𝚎𝚛𝚖𝚒𝚗𝚐𝚐𝚞 𝚁𝚙. 𝟽.𝟶𝟶𝟶`
let message = await prepareWAMessageMedia({ image: fs.readFileSync('./Image/gopaykir.jpg') }, { upload: RifqiBotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
...
{
urlButton: {
displayText: 'Owner Mbemcans Botz',
url: 'https://wa.me/6285377536527'
}
}]
}
...
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
donte = `Donasikan rejeki mu untuk Mbemcans botz`
let message = await prepareWAMessageMedia({ image: fs.readFileSync('./Image/gopaykir.jpg') }, { upload: RifqiBotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
...
await RifqiBotz.groupAcceptInvite(result).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
}
break
...
let response = await RifqiBotz.groupInviteCode(m.chat)
RifqiBotz.sendText(m.chat, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
}
break
case 'antilink':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
await RifqiBotz.sendButtonText(m.chat, buttons, `Mode Antilink`, RifqiBotz.user.name, m)
}
break
case 'antiwame':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
replyNya(`Antiwame Berhasil Di Nonaktifkan !`)
} else {
let buttons = [
{ buttonId: 'antiwame enable', buttonText: { displayText: 'On' }, type: 1 },
{ buttonId: 'antiwame disable', buttonText: { displayText: 'Off' }, type: 1 }
]
await RifqiBotz.sendButtonText(m.chat, buttons, `Mode Antiwame`, RifqiBotz.user.name, m)
}
break
case 'listgc': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
for (let i of anu) {
 let metadata = await RifqiBotz.groupMetadata(i)
...
await RifqiBotz.sendButtonText(m.chat, buttons, `Mode Autosticker`, RifqiBotz.user.name, m)
}
					break
...
if (args[0] === 'close'){
await RifqiBotz.groupSettingUpdate(m.chat, 'announcement').then((res) => replyNya(`Sukses Menutup Group`)).catch((err) => reply(jsonformat(err)))
} else if (args[0] === 'open'){
await RifqiBotz.groupSettingUpdate(m.chat, 'not_announcement').then((res) => replyNya(`Sukses Membuka Group`)).catch((err) => reply(jsonformat(err)))
} else {
let buttons = [
{ buttonId: 'group open', buttonText: { displayText: 'Open' }, type: 1 },
{ buttonId: 'group close', buttonText: { displayText: 'Close' }, type: 1 }
]
await RifqiBotz.sendButtonText(m.chat, buttons, `Mode Group`, RifqiBotz.user.name, m)
}
}
break
case 'welcome': {
...
case 'bye': {
if (!m.isGroup) return
await replyTemplate(`Awogwogwog🗿`)
}
break
case 'apakah':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (args.length < 1) return replyNya(`Contoh : ${prefix + command} RifqiBotz`)
cantik = body.slice(1)
...
RifqiBotz.sendMessage(m.chat, { text: `${yn}%` }, { quoted: fakeRifqiBotz })
break
case 'jadian': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!m.isGroup) throw mess.group
...
await RifqiBotz.sendButtonText(m.chat, buttons, jawab, RifqiBotz.user.name, m, {mentions: menst})
}
break
case 'bisakah':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
var media = await RifqiBotz.downloadAndSaveMediaMessage(quoted, 'ppbot.jpeg')
if (args[0] == `'panjang'`) {
var { img } = await generateProfilePicture(media)
await RifqiBotz.query({
tag: 'iq',
attrs: {
to: m.chat,
type:'set',
...
var memeg = await RifqiBotz.updateProfilePicture(m.chat, { url: media })
fs.unlinkSync(media)
reply(`Sukses`)
}
}
...
var memeg = await RifqiBotz.updateProfilePicture(botNumber, { url: media })
fs.unlinkSync(media)
reply(`Sukses`)
}
}
...
let media = await RifqiBotz.downloadAndSaveMediaMessage(quoted)
await RifqiBotz.updateProfilePicture(m.chat, { url: media }).catch((err) => fs.unlinkSync(media))
replyNya(mess.success)
}
break
...
if (!isAdmins) throw mess.admin
if (!text) throw 'Text ?'
await RifqiBotz.groupUpdateSubject(m.chat, text).then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
}
break
...
if (!isAdmins) throw mess.admin
if (!text) throw 'Text ?'
await RifqiBotz.groupUpdateDescription(m.chat, text).then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
}
break
/**case 'add': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
await RifqiBotz.groupParticipantsUpdate(m.chat, [users], 'add').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
}
break**/
/**case 'kick': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
if (!isAdmins) throw mess.admin
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await RifqiBotz.groupParticipantsUpdate(m.chat, [users], 'remove').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
}
break**/
case 'tagall': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
RifqiBotz.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted: fakeRifqiBotz })
}
break
case 'hidetag': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!m.isGroup) throw mess.group
if (!isAdmins) throw mess.admin
RifqiBotz.sendMessage(m.chat, { text : q ? q : '' , mentions: participants.map(a => a.id)}, { quoted: fakeRifqiBotz })
}
break
case 'promote': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
if (!isAdmins) throw mess.admin
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await RifqiBotz.groupParticipantsUpdate(m.chat, [users], 'promote').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
}
break
case 'demote': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
if (!isAdmins) throw mess.admin
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await RifqiBotz.groupParticipantsUpdate(m.chat, [users], 'demote').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
}
break
...
sticWait(from)
                    ...
                    RifqiBotz.sendMessage(m.chat, { image: fol, caption: ini_txt }, { quoted: fakeRifqiBotz})                  
                    get_audio = await getBuffer(ani.audio[0].link)
                    RifqiBotz.sendMessage(m.chat, {audio: get_audio, mimetype: 'audio/mpeg', fileName: `${ani.title}.mp3`}, { quoted : fakeRifqiBotz })
                    break
case 'play':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
/**if (!isPrem) return replyPremium(mess.premium)**/
...
RifqiBotz.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `✇ Title : ${media.title}\n✇ File Size : ${media.filesizeF}\n✇ Url : ${isUrl(text)}\n✇ Ext : MP4\n✇ Resolusi : ${args[1] || '360p'}` }, { quoted: fakeRifqiBotz })
}
break
...
if (media.filesize >= 100000) return replyNya('File Melebihi Batas '+util.format(media))
RifqiBotz.sendImage(m.chat, media.thumb, `✇ Title : ${media.title}\n✇ File Size : ${media.filesizeF}\n✇ Url : ${isUrl(text)}\n✇ Ext : MP3\n✇ Resolusi : ${args[1] || '128kbps'}`, m)
RifqiBotz.sendMessage(m.chat, { audio: { url: media.dl_link }, mimetype: 'audio/mp4', ptt:true, contextInfo:{externalAdReply:{
showAdAttribution: true,
                title: `Hai Kak ${pushname}`,
                body: `© 2022`,
                thumbnail: thumb,
...
if (!q) throw `Link Nya?`
sticWait(from)
RifqiBotz.sendMessage(from, { image: { url: `https://api.lolhuman.xyz/api/ssweb?apikey=${lolkey}&url=${q}`}})
break
case 'xnxxsearch':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
/**if (!isPrem) return replyPremium(mess.premium)**/
...
RifqiBotz.sendMessage(from, { text: anu }, { quoted: fakeRifqiBotz })
break
              case 'spotifysearch':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
              /**if (!isPrem) return replyPremium(mess.premium)**/
...
sticWait(from)
                    ...
                    await RifqiBotz.sendMessage(m.chat, { image: fott, caption: ini_txt }, { quoted: fakeRifqiBotz})                  
                    break
...
RifqiBotz.sendMessage(from, { audio: { url: res.audio }, mimetype: 'audio/mp4', ptt:true, contextInfo:{externalAdReply:{
showAdAttribution: true,
title: `Hai Kak ${pushname}`,
...
let message = await prepareWAMessageMedia({ video : { url: anu.nowm } }, { upload: RifqiBotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
...
title: a.title, description: `Channel: ${a.author.name} | Durasi: ${a.duration}`, rowId: `${prefix}play ${a.url}`
    ...
    const button = {
        ...
        footerText: `Create by RifqiBotz`,
        ...
        RifqiBotz.relayMessage(m.chat, templateList.message, { messageId: templateList.key.id });
break
...
RifqiBotz.sendMessage(m.chat, { image: { url: random }, caption: `Nih Kak` }, { quoted: fakeRifqiBotz })
}
break
case 'wallpaperinori':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
RifqiBotz.sendMessage(m.chat, { image: { url: random.male }, caption: `Foto Couple Male` }, { quoted: fakeRifqiBotz })
RifqiBotz.sendMessage(m.chat, { image: { url: random.female }, caption: `Fofo Couple Female` }, { quoted: fakeRifqiBotz })
}
break
case 'tiktokstalk':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
let message = await prepareWAMessageMedia({ image: buffer }, { upload: RifqiBotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
RifqiBotz.sendMessage(m.chat, { image: thumbnail, caption: ini_txt }, { quoted: fakeRifqiBotz})
break
case 'pacarserti':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
/**if (!isPrem) return replyPremium(mess.premium)**/
...
let message = await prepareWAMessageMedia({ image: wehw }, { upload: RifqiBotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
